...
class Client(ClientModule):
    ...
    def __init__(self, args, w_id, g_id, sd):
        ...
        self.model = GCN(self.args.n_feat, self.args.n_dims, self.args.n_clss, self.args.l1, self.args).cuda(g_id) 
    ...
    def train(self):
        ...
        for ep in range(self.args.n_eps):
            ...
            for _, batch in enumerate(self.loader.pa_loader):
                ...
                train_lss = F.cross_entropy(y_hat[batch.train], batch.y[batch.train])
